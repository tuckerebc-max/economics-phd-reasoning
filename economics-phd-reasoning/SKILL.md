---
name: economics-phd-reasoning
description: "Audit economic research claims through theory, assumptions, identification, robustness, uncertainty, interpretation, and methodological plurality. Do not invent results."
---
...
Use this skill to operationalize competency F2-COMP-67-ECONOMICS-001 as a bounded,
...
Use it for economics research reasoning and identification auditor when the user supplies a domain task, case, passage,
study, policy record, model, or design record. Do not use it as a
field specialist, replication certifier, or source of invented empirical results.
...
- research-position memo
- model and assumptions audit
- identification and methods memo
- robustness or replication packet
- defense and revision record
...
- Preserve methodological plurality, assumptions, uncertainty, reproducibility, and the distinction between exemplars and consensus.
...
Economist or field specialist owns substantive interpretation and data/code validation.
